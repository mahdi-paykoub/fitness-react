...
export default function UserDashboard() {
    ...
    return (
        <>
            <Container fluid>
                <Row>
                    <Col lg={2} className='bg-white p-3 col-2-5 border-start d-none d-lg-block '>
