    ...
    return (
        <>
            <Container className='bg-global-light mt-5'>
                <Row>
                    <Col lg={5} className='align-content-center position-relative '>
                        ...
                        <p className='mt-3 header-subtext'>
                    ...
                    <Col className='position-relative'>
                        ...
                        {/* floats */}
                        <div className='position-absolute dumbbell-float-box align-items-center justify-content-center d-flex up-down-animation'>
                            <FaDumbbell className='text-white' />
                        </div>
                        <div className='position-absolute fit-float-box align-items-center justify-content-center d-flex right-left-animation'>
