                    ...
                    <Col lg={9}>
                        <Row>
                            <Col className='mt-4' lg={4}>
                                <div className='course-card p-3 cursor-pointer'>
                                    <div className='position-relative'>
                                        <img src="/images/courses/img.avif" alt="" className='w-100' />
                                    </div>
                                    <div className='d-flex justify-content-between align-items-center mt-3 '>
                                        ...
                                        {/* <div className='fs12 c-text-secondary teacher-badge'>آرمان کرد بچه</div> */}
                                        <div className=''>
                                    ...
                                    <div className='mt-3 fw-bold c-text-secondary lh-1-8'>
                                        دوره برنامه نویسی برنی برای بدنسازی و پرورش اندام به صورت اصولی
                                    </div>

                                    <div className='d-flex justify-content-between align-items-center fw-bold mt-4 pt-2 pb-2'>
                                        <div className='c-text-secondary'>
                                            <span className='fs30'> 1.9</span>
                                            <span>تومان</span>
                                        </div>
                                        <div>
                                            <Link className='fs14 show-m-course'>
                                                مشاهده دوره
                                            </Link>
                                        </div>
                                    </div>
                            ...
                            <Col className='mt-4' lg={4}>
                                <div className='course-card p-3 cursor-pointer'>
                                    <div className='position-relative'>
                                        <img src="/images/courses/courses.avif" alt="" className='w-100' />
                                    </div>
                                    <div className='d-flex justify-content-between align-items-center mt-3 '>
                                        <div className='d-flex align-items-center'>
                                            <svg width="20" height="20" viewBox="0 0 25 20" fill="none">
                            ...
                            <Col className='mt-4' lg={4}>
                                <div className='course-card p-3 cursor-pointer'>
                                    <div className='position-relative'>
                                        <img src="/images/courses/image.avif" alt="" className='w-100' />
                                    </div>
                                    <div className='d-flex justify-content-between align-items-center mt-3 '>
                                        <div className='d-flex align-items-center'>
                                            <svg width="20" height="20" viewBox="0 0 25 20" fill="none">
