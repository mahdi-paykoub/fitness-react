        ...
        <>
            {
                ...
                <Container className='pb-5 mb-5'>
                    ...
                    <div className='bg-white br-10 px-3' style={{'boxShadow' : ' 5px 0px 10px #ebebeb'}}>
                        <Row className='mt-4 align-items-center pe-3'>
                            ...
                            <Col lg={6} className='text-center'>
                                <img src="/images/3304470.jpg" className='w-75' alt="" />
                            </Col>
                        </Row>
                    ...
                    <Row className='mt-2'>
                        <Col lg={3} className='mt-4'>
                            <div className='box-1 p-4 br-10 text-secondary'>
                                ...
                                <div className='fflalezar fs20  mt-3'>
                                    مدت زمان دوره
                                </div>
                                <div className='mt-3 fs14 text-secondary ps-5 lh2'>
                        ...
                        <Col lg={3} className='mt-4'>
                            <div className='box-1 p-4 br-10 '>
                                ...
                                <div className='fflalezar fs20 text-secondary mt-3'>
                                    امکان ارسال تیکت
                                </div>
                                <div className='mt-3 fs14 text-secondary ps-5 lh2'>
                        ...
                        <Col lg='12'>
                            <div className='bg-white br-10 p-4 mt-4'>
                                ...
                                <div className='color-2 fw-bold c-text-secondary d-flex align-items-center'>
                                    ...
                                    <div className='me-1 fs25 fflalezar'> توضیحات</div>
                                </div>
