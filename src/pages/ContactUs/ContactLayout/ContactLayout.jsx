...
export default function ContactLayout() {
    ...
    return (
        <>
            <Container fluid>
                <Row>
                    <Col lg={2} className='bg-white p-3 col-2-5 border-start d-none d-lg-block ' style={{ minHeight: '100vh' }}>
                        <div className='ck-sticky-panel__content'>
                            ...
                            <div className='mt-4'>
                                ...
                                <NavLink to="/cooperate-with-us" className={setActive} end >
                                    <div className='d-flex align-items-center panel-items'>
                                        <RxDashboard fontSize={20} />
                                        <div className='fs14 me-2'>درخواست همکاری </div>
                                    </div>
                                </NavLink>

                                <NavLink to="/cooperate-with-us/cooperation-code" className={setActive} end >
                                    <div className='d-flex align-items-center panel-items'>
                                        <CiBarcode fontSize={22} />
                                        <div className='fs14 me-2'>کد معرف</div>
                                    </div>
                                </NavLink>

                                <NavLink to="/cooperate-with-us/bank-account" className={setActive} end >
                                    <div className='d-flex align-items-center panel-items'>
                                        <CiCreditCard2 fontSize={22} />
                                        <div className='fs14 me-2'>حساب بانکی</div>
                                    </div>
                                </NavLink>
                                <NavLink to="/cooperate-with-us/settlement" className={setActive} end >
                                    <div className='d-flex align-items-center panel-items'>
                                        <FcSimCardChip fontSize={22} />
                                        <div className='fs14 me-2'>تسویه حساب</div>
                                    </div>
                                </NavLink>
                                <NavLink to="/cooperate-with-us/messages" className={setActive} end >
                                    <div className='d-flex align-items-center panel-items'>
                                        <HiOutlineBellAlert  fontSize={22} />
                                        <div className='fs14 me-2'>پیام ها</div>
                                    </div>
                                </NavLink>
                    ...
                    <Col className='col-9-5' lg={10}>
                        <div className='d-flex mt-3 px-3 align-items-center justify-content-between panel-navbar'>
                            <div style={{ 'color': '#3f3f46' }}>
                                <LuMenu variant="primary" onClick={handleShow} fontSize={20} className='d-lg-none ms-3 cursor-pointer' />
                                <span className='fs18 fw-bold'> {authContext.userInfo.data.name} </span>
                                <span>
                                    <span className='fs18 fw-bold'>؛ خوش اومدی</span>
                                    <img src="/images/5. Cool.png" width={50} height={50} alt="" />
                                    <span className='fs12 text-secondary pe-3 border-end d-none d-lg-inline'>
                                        <span className='fs12'>تاریخ : </span>
                                        <span dir='ltr'>{format(currentDate, "yyyy-MM-dd")}</span>
